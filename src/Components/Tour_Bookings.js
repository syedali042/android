...
function Tour_Bookings(props) {

    const tour_id = props.match.params.id;
    let todayDate = new Date().toISOString().slice(0, 10)
    const [bookingPersonPriceTotal, setBookingPersonPriceTotal] = useState([]);
    const [bookingCoupleCharges, setBookingCoupleTotalCharges] = useState([]);
    ...
    const handleSubmit = async (event) => {
        ...
        let req = {
            ...
            request_tour_id:tour_id,
            request_persons: data.request_persons.value,
            request_couple: data.request_couple.value,
        ...
        if(res){
            ...
            setBookingCoupleTotalCharges(resp.couple_price);
               ...
               <form action="javascript://" className="create-booking-form" onSubmit={handleSubmit}>
                ...
                <div className="success-response" style={{display: 'none'}}>
                    ...
                    <div className="p-3">
                        ...
                        <p className="mb-1 text-muted"> Person Charges<span style={{float:'right'}} id="person_price" className="person_price float-right text-dark">Rs.{bookingPersonPriceTotal}/-</span></p>
                            <p className="mb-1 text-muted">Couple Charges <span style={{float:'right'}} id="persons" className="persons float-right text-dark">Rs.{bookingCoupleCharges}/-</span></p>
                            <hr />
