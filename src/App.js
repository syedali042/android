    ...
    <>
      {LoginUser ? (
        <Switch>
          ...
          <Route
            path="/tour_booking_details/:id"
            exact
            component={Tour_Booking_Details}
          />
          <Route
            path="/adventure_listing/:id"
            exact
            component={Adventure_Listing}
          />
          <Route path="/adventure_details/:id" exact component={Ad_Details} />
          <Route path="/adventure_booking/:id" exact component={Ad_Booking} />
          <Route
            path="/adventure_booking_details/:id"
            exact
            component={AdBookingDetails}
          />
          <Route path="/places_listing/:id" exact component={PlacesListing} />
          <Route path="/places_details" exact component={Places_Details} />
          <Route
            path="/tour_company_details"
            exact
            component={TourComDetails}
          />
          <Route path="/EditProfile" exact component={EditProfile} />
          <Route
            path="/adventure_company_details"
            exact
            component={AdComDetails}
          />
          ...
          <Route
            path="/adventureBookings"
            exact
            component={AdventureBookings}
          />
...
// Firebase Certificate // 6C:DF:40:0A:7A:12:70:5E:17:A9:C7:8F:63:10:28:8B:EF:63:EF:EA
export default App;
